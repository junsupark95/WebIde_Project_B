...
import social.PrincipalDetails;
...
//        model.addAttribute("user", "hey");
    ...
    public String createRoom(@RequestParam("roomName") String name, @RequestParam(value = "maxUserCnt", defaultValue = "100")String maxUserCnt, RedirectAttributes rttr) {
